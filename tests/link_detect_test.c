...
static void test_link_detect_matrix(void) {
	static const LinkCase cases[] = {
		...
		{"https://example.com).", TRUE, LDS_LINK_KIND_URL, "https://example.com"},
			...
			{"user@domain.engineering", TRUE, LDS_LINK_KIND_EMAIL, "mailto:user@domain.engineering"},
			{"example.photography/path", TRUE, LDS_LINK_KIND_DOMAIN, "https://example.photography/path"},
			{"main.c", FALSE, 0, NULL},
